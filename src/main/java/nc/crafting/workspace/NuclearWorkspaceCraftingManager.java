...
public class NuclearWorkspaceCraftingManager {
	...
	public NuclearWorkspaceCraftingManager() {
    	...
    	if (NuclearCraft.workspace) {
	    	...
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.cellBlock, 1), true, new Object[] {"LNTNL", "NP PN", "T   T", "NP PN", "LNTNL", 'N', "plateBasic", 'P', "platingLead", 'L', "blockGlass", 'T', "ingotTough"}));
	    	...
	    	//this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCItems.parts, 1, 7), true, new Object[] {" NNN ", "NWWWN", "NWWWN", " NNN ", 'N', "platingTin", 'W', new ItemStack(NCItems.fuel, 1, 34)}));
	    	...
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCItems.upgradeSpeed, 1), true, new Object[] {"TTT", "TNT", "TTT", 'N', "platingIron", 'T', "dustLapis"}));
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCItems.upgradeEnergy, 1), true, new Object[] {"TTT", "TNT", "TTT", 'N', "platingIron", 'T', "universalReactant"}));
	    	
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.tubing1, 8), true, new Object[] {" NNN ", "NIIIN", " NNN ", 'N', "platingLead", 'I', "platingIron"}));
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.tubing2, 8), true, new Object[] {" N ", "NIN", "NIN", "NIN", " N ", 'N', "platingLead", 'I', "platingIron"}));
	
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.separatorIdle, 1), true, new Object[] {"TNNNT", "NUUUN", "NUMUN", "NUUUN", "TNNNT", 'N', "platingLead", 'T', Items.redstone, 'U', "ingotTough", 'M', NCBlocks.machineBlock}));
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.hastenerIdle, 1), true, new Object[] {"TNNNT", "NUUUN", "NUMUN", "NUUUN", "TNNNT", 'N', "platingLead", 'T', "ingotTough", 'U', "universalReactant", 'M', NCBlocks.machineBlock}));
	    	...
	    	//this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.reactionGeneratorIdle, 1), true, new Object[] {"TNNNT", "NLULN", "NUMUN", "NLULN", "TNNNT", 'N', Items.redstone, 'T', "plateBasic", 'L', "platingLead", 'U', new ItemStack(NCItems.parts, 1, 5), 'M', NCBlocks.machineBlock}));
	    	//this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.electrolyserIdle, 1), true, new Object[] {"TNNNT", "NLLLN", "NUMUN", "NLLLN", "TNNNT", 'N', new ItemStack (NCItems.parts, 1, 3), 'T', "universalReactant", 'L', "platingLead", 'U', new ItemStack(NCItems.parts, 1, 7), 'M', NCBlocks.machineBlock}));
	    	//this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.oxidiserIdle, 1), true, new Object[] {"TNNNT", "NUUUN", "NUMUN", "NUUUN", "TNNNT", 'N', "platingLead", 'T', "plateDU", 'U', "universalReactant", 'M', NCBlocks.machineBlock}));
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.ioniserIdle, 1), true, new Object[] {"TNNNT", "NUUUN", "NUMUN", "NUUUN", "TNNNT", 'N', "platingLead", 'T', "plateDU", 'U', Items.redstone, 'M', NCBlocks.machineBlock}));
	    	...
	    	//this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.factoryIdle, 1), true, new Object[] {"TNNNT", "NUUUN", "NUMUN", "NUUUN", "TNNNT", 'T', "ingotTough", 'N', "plateBasic", 'U', "platingIron", 'M', Blocks.piston}));
	    	//this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.assemblerIdle, 1), true, new Object[] {"TNNNT", "NUUUN", "NUMUN", "NUUUN", "TNNNT", 'T', "ingotTough", 'N', "platingIron", 'U', "plateBasic", 'M', Blocks.piston}));
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.heliumExtractorIdle, 1), true, new Object[] {"TNNNT", "NUUUN", "NUMUN", "NUUUN", "TNNNT", 'T', new ItemStack(NCItems.parts, 1, 5), 'N', "plateReinforced", 'U', "platingTin", 'M', NCBlocks.machineBlock}));
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.recyclerIdle, 1), true, new Object[] {"TNNNT", "NUUUN", "NUMUN", "NUUUN", "TNNNT", 'N', "platingLead", 'T', "ingotHardCarbon", 'U', "ingotTough", 'M', NCBlocks.machineBlock}));
	    	...
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.RTG, 1), true, new Object[] {"GCCCG", "CTTTC", "CTXTC", "CTTTC", "GCCCG", 'G', "alloyElite", 'C', "platingLead", 'T', new ItemStack(NCItems.parts, 1, 8), 'X', new ItemStack(NCItems.fuel, 1, 46)}));
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.AmRTG, 1), true, new Object[] {"GCCCG", "CTTTC", "CTXTC", "CTTTC", "GCCCG", 'G', "alloyAdvanced", 'C', "platingLead", 'T', new ItemStack(NCItems.parts, 1, 3), 'X', new ItemStack(NCItems.fuel, 1, 139)}));
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.CfRTG, 1), true, new Object[] {"GCCCG", "CTTTC", "CTXTC", "CTTTC", "GCCCG", 'G', "alloyUltimate", 'C', "platingLead", 'T', new ItemStack(NCItems.parts, 1, 9), 'X', new ItemStack(NCItems.fuel, 1, 140)}));
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.WRTG, 1), true, new Object[] {" PPP ", "PUUUP", "PUUUP", "PUUUP", " PPP ", 'P', "platingLead", 'U', "U238"}));
	    	//this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.steamGenerator, 2), true, new Object[] {"PPPPP", "PCCCP", "MMMMM", "PCCCP", "PPPPP", 'P', "platingIron", 'C', new ItemStack(NCItems.parts, 1, 12), 'M', new ItemStack(NCItems.parts, 1, 19)}));
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.steamDecompressor, 2), true, new Object[] {"PPPPP", "PCCCP", "GMMMG", "PCCCP", "PPPPP", 'P', "platingIron", 'C', Blocks.piston, 'G', new ItemStack(NCItems.parts, 1, 10), 'M', new ItemStack(NCItems.parts, 1, 19)}));
	    	...
	    	// this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.solarPanel, 1), true, new Object[] {"CTTTC", "CXXXC", "CSSSC", "CGGGC", "CCCCC", 'S', "dustCoal", 'G', new ItemStack(NCItems.parts, 1, 12), 'C', "platingIron", 'T', new ItemStack(NCItems.parts, 1, 15), 'X', "universalReactant"}));
